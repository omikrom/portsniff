...
var rusha = createCommonjsModule(function (module, exports) {
  (function (f) {
    {
      module.exports = f();
    }
...
function sha1$1(password) {
  return new Promise(function (resolve) {
    browser(password, function (hash) {
...
function notPwned(password) {
  return sha1$1(password).then(function (passwordHash) {
